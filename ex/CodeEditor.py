...
class CodeEditorView(ui.View):
    ...
    def __init__(self, mode='python', ext_kb=True, *args, **kwargs):
        ...
        valid_modes = {'python': 'OMPythonSyntaxHighlighter', 'html': 'OMHTMLSyntaxHighlighter',
                       'javascript': 'OMJavaScriptSyntaxHighlighter', 'markdown': 'OMMarkdownSyntaxHighlighter',
        ...
        if ext_kb:
            kb_types = {'python': 'KeyboardAccessoryTypePythonCompact',
                        'markdown': 'KeyboardAccessoryTypeMarkdownWithoutSnippets', 'html': 'KeyboardAccessoryTypeHTML',
